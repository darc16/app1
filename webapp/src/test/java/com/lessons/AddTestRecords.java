...
private boolean getRandomBoolean(){
    ...
    private void createIndicators(int totalIndicators, int reportId){
        ...
        String sql = "Insert into indicators (id, value, ind_type) values (" + indicatorInsertValues + ")";
        jt.update(sql);

        sql = "Insert into link_reports_indicators (report, indicator) values (" + lriInsertValues + ")";
        jt.update(sql);

        sql = "Insert into indicators_aud (id, value, rev, rev_type, user_name, ind_type, timestamp) values (" + auditInsertValues + ")";
        jt.update(sql);
    }
